...
export const projects = [
    ...
    
    {
        ...
        description: "<p><strong>Basketball Court Finder</strong> is a web app that helps users locate basketball courts near them using interactive maps. It allows users to search for courts based on location, view court details, and rate their experiences, making it easy to find and explore local basketball courts! 🏀</p>",
